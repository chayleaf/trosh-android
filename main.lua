function love.load()
	...
	for i = 1, #imagelist do
		_G[imagelist[i] .. "img"] = love.graphics.newImage("" .. imagelist[i] .. ".png")
	end
	...
	playerimg = love.graphics.newImage("trosh.png")
	...
	winplayerimg = love.graphics.newImage("troshwin.png")
	winplayerquad = {}
	for x = 1, 4 do
	...
	bigexplosionimg = love.graphics.newImage("bigexplosion.png")
	bigexplosionquad = {}
	for y = 1, 5 do
		for x = 1, 5 do
	...
	splatterimg = love.graphics.newImage("splatter.png")
	splatterquad = {}
	for x = 1, 6 do
	...
	scale = h/80
	hund = w/scale
	if w ~= hund*scale or h ~= 80*scale then
		love.window.setMode(100*scale, 80*scale)
	end
	
	bgmusic = love.audio.newSource("trosong.ogg")
	bgmusic:setLooping(true)
	lasersound = love.audio.newSource("laser.wav")
	bigexplosionsound = love.audio.newSource("bigexplosion.ogg")
	explosionsound = love.audio.newSource("explosion.wav")
	launchsound = love.audio.newSource("launch.ogg")
	gunfire = love.audio.newSource("gunfire.wav")
	space = love.audio.newSource("space.ogg")
	sunglassessound = love.audio.newSource("sunglasses.ogg")
	splat = love.audio.newSource("splat.ogg")
	ding = love.audio.newSource("ding.ogg")
	credits = love.audio.newSource("credits.ogg")
	approach = love.audio.newSource("approach.ogg")
...
function love.draw()
	...
	if fade > 0 then
		...
		love.graphics.rectangle("fill", 0, 0, hund*scale, 80*scale)
